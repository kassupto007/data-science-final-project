...
def EDA():
    ...
    persons_injured_by_year = df.groupby("BOROUGH")[["NUMBER OF PERSONS INJURED", "NUMBER OF PEDESTRIANS INJURED","NUMBER OF CYCLIST INJURED", "NUMBER OF MOTORIST INJURED"]].sum()
    print(persons_injured_by_year)
    persons_injured_by_year.plot.bar(figsize=(12,6))
    ...
    killed_by_borough = df.groupby("BOROUGH")[["NUMBER OF PERSONS KILLED", "NUMBER OF PEDESTRIANS KILLED","NUMBER OF CYCLIST KILLED", "NUMBER OF MOTORIST KILLED"]].sum()
